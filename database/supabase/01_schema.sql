...
-- Stores Table for managing web stores 
...
CREATE INDEX IF NOT EXISTS stores_url_idx ON public.stores(url);
...
-- Stores policies: Anyone can view stores, users can manage their own
