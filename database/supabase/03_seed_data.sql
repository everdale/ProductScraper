...
INSERT INTO public.stores (name, url, logo_url, category, status, config, last_crawl, product_count)
VALUES
  (
    'ElectroShop',
    'https://electroshop-example.com',
    'https://electroshop-example.com/logo.png',
    'Electronics',
    'active',
    '{"selectors": {"product_list": ".products-grid", "product_link": ".product-item a", "pagination": ".pagination .next", "name": "h1.product-title", "price": ".price", "description": ".product-description", "image": ".product-image img"}, "max_pages": 10, "crawl_frequency_hours": 24}',
    NOW() - INTERVAL '2 days',
    42
  ),
  (
    'HomeStyle',
    'https://homestyle-example.com',
    'https://homestyle-example.com/logo.png',
    'Home Goods',
    'active',
    '{"selectors": {"product_list": ".product-listing", "product_link": ".product-card a", "pagination": ".pager a.next", "name": ".product-name", "price": ".product-price", "description": ".product-details", "image": ".product-gallery img"}, "max_pages": 5, "crawl_frequency_hours": 48}',
    NOW() - INTERVAL '5 days',
    28
  ),
  (
    'FurnitureDepot',
    'https://furnituredepot-example.com',
    'https://furnituredepot-example.com/logo.png',
    'Furniture',
    'pending',
    '{"selectors": {"product_list": ".furniture-grid", "product_link": ".item-card a", "pagination": ".pages a:last-child", "name": ".item-title", "price": ".item-price", "description": ".item-description", "image": ".item-image img"}, "max_pages": 8, "crawl_frequency_hours": 72}',
    NULL,
    0
  ); 